...
class PythonQuizApp:
    ...
    def show_question(self):
        ...
        # Display question
        st.subheader(f"Question {st.session_state.current_question + 1} of {len(self.questions)} (Q{401 + st.session_state.current_question + 1})")
    ...
    def show_results(self):
        ...
        for i, answer in enumerate(st.session_state.user_answers):
            with st.expander(f"Question {401 + i + 1}: {answer['question']}"):
